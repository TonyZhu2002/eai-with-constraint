...
subgoal_constraint_mode = os.environ.get(
    "BEHAVIOR_SUBGOAL_CONSTRAINT_MODE", global_config.get("subgoal_constraint_mode", "baseline")
)
subgoal_constraint_mode = str(subgoal_constraint_mode).lower()
logger.debug(f"Subgoal Constraint Mode: {subgoal_constraint_mode}")
